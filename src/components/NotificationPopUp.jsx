...
const NotificationPopUp = () => {
  ...
  return (
    <div className="notification fixed bottom-6 right-6 min-w-96 border border-slate-200 bg-white p-6 rounded text-black transition-opacity duration-300 text-sm space-y-1">
      <button
